...
const Map<String, String> _domainShortLabels = {
  'Implementing Advanced Sourcing': 'Advanced Sourcing',
  'Implementing Advanced SSO Strategies': 'Advanced SSO',
  'Implementing Custom Configuration Options with Okta': 'Custom Config',
  'Implementing Directory Solutions': 'Directory Solutions',
  'Implementing Inbound Federation with Okta': 'Inbound Federation',
  'Implementing Okta Policies': 'Okta Policies',
  'Working with Okta APIs': 'Okta APIs',
  'Working with API Access Management': 'API Access Mgmt',
  'App Integrations': 'App Integrations',
  'Creating a Custom Admin': 'Custom Admin',
  'Configuring Policies': 'Policies',
  'Creating Routing Rules': 'Routing Rules',
  'Active Directory Integration': 'AD Integration',
  'Profiles, Sourcing & Write-Back Concepts': 'Profiles & Sourcing',
  'Custom Application Integration': 'Custom Apps',
        ...
        children: [
          ...
          for (final domain in domains)
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 4),
              child: ChoiceChip(
                label: Text(_domainShortLabels[domain] ?? domain),
