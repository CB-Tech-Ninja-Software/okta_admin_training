...
/// Represents a Part II hands-on sequence / decision scenario.
class Scenario {
  final String id;
  final String domain;
  final int useCaseNumber; // 1, 2, 3, or 4
  final String title;
  ...
  factory Scenario.fromMap(Map<String, dynamic> map) {
    ...
    return Scenario(
      ...
      useCaseNumber: map['use_case_number'] as int? ?? map['useCaseNumber'] as int? ?? 1,
  ...
  factory Scenario.fromJson(Map<String, dynamic> json) {
    ...
    return Scenario(
      ...
      useCaseNumber: json['useCaseNumber'] as int? ?? json['use_case_number'] as int? ?? 1,
