...
class SeedImporter {
  ...
  Future<SeedSummary> seedFromAssets({
    ...
    // Reference notes shipped after questions/flashcards/scenarios were
    // already seeding on real devices. Devices that were seeded before this
    // feature existed would otherwise never pick up reference_notes.json,
    // since isSeeded() is a single global flag - so this source is checked
    // independently of that flag (empty-table check) rather than gated by
    // wasAlreadySeeded like the original three sources.
    ...
    // 4. Load Reference Notes - independent of skipCoreSources, see comment above.
